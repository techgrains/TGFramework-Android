...
public class TGJsonBodyStringRequest<T extends TGResponse> extends Request<T> {
    ...
    public TGJsonBodyStringRequest(int method, String url, String requestBody, TGIResponseListener<T> listener) {
    ...
    public TGJsonBodyStringRequest(int method, String url, String requestBody, TGIResponseListener<T> listener, Type type) {
        super(method, url, null);
        setRetryPolicy();
        this.listener = listener;
        mRequestBody = requestBody;
    ...
    public TGJsonBodyStringRequest(int method, String url, String requestBody, TGIResponseListener<T> listener, int timeout, int maxRetries ) {
        super(method, url, null);
    ...
    public TGJsonBodyStringRequest(int method, String url, String requestBody, TGIResponseListener<T> listener, Type type, int timeout, int maxRetries ) {
        super(method, url, null);
        setRetryPolicy(timeout, maxRetries);
        this.listener = listener;
        mRequestBody = requestBody;
